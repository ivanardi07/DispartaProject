...
<html lang="<?= Yii::$app->language ?>">
   ...
   <body class="off-canvas-sidebar login-page">
      ...
      <div class="wrapper wrapper-full-page">
         <!-- <div class="login"> -->
         <div class="page-header login-page header-filter" filter-color="black" style="background-image: url('../../img/bg_cover.jpg'); background-size: cover; background-position: top center;">
